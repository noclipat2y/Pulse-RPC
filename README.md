...
> [!NOTE]
> **PulseRPC никак не связан с другими модами или сторонними модификациями.**
>
> Проект был создан и разрабатывается независимо по собственной инициативе автора.
>
> Мы не несем ответственности за работу сторонних модов, использующих функции PulseRPC без разрешения.
